...
abstract class PluginBlogPostForm extends BaseBlogPostForm
{
    public function setup()
    {
        $this->setWidgets(array(
            ...
            'short' => new sfWidgetFormTextarea(),
        ...
        $this->setValidators(array(
            ...
            'meta_title' => new sfMainPlugin\Validator\sfValidatorString(array('max_length' => 255)),
            'meta_keywords' => new sfMainPlugin\Validator\sfValidatorString(array('max_length' => 1000)),
            'meta_description' => new sfMainPlugin\Validator\sfValidatorString(array('max_length' => 2000)),
        ));
